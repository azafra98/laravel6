    ...
    <div class="container-fluid text-secondary">
        <div class="auth">
            ...
            <div class="auth__body">
                <form class="auth__form__register" method="POST" action="{{url('/editarPerfil', ['id' => $u->id])}}"  enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="imagenAntigua" value="{{$u->imagenusuario}}">
                    <div class="auth__form_body">
                        <h3 class="auth__form_title text-center">{{ __('Editar Perfil') }}</h3>
