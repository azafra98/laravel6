    ...
    <div class="container-fluid text-secondary">
        <div class="auth">
            ...
            <div class="auth__body">
                <form class="auth__form__register" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="auth__form_body">
                        <h3 class="auth__form_title text-center p-3">{{ __('Registrar') }}</h3>
                        ...
                        <div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="insta_user" type="text" class="form-control @error('insta_user') is-invalid @enderror" name="insta_user" value="{{ old('insta_user') }}" autocomplete="insta_user" autofocus>
